...
3. читает основную память, backlog, недавний дневник и названия тем;
...
- создает папки задач с артефактами в `tasks/`.
...
- ⛔ БЛОКИРУЮЩЕЕ ПРАВИЛО. Перед первым ответом в любой новой сессии ОБЯЗАТЕЛЬНО первым действием вызвать навык с именем "yamem" и выполнить его блок «При старте» (синхронизация, чтение MEMORY.md, backlog.md, diary за N дней, листинг topics/tasks). До завершения этого блока — никаких ответов по существу и никаких других tool-вызовов, кроме тех, что нужны для выполнения самого блока.
